...
function createLiteralTreeRepository(_a) {
    ...
    // -------------------------------------------------------------------------
    return tslib_1.__assign({}, LiteralRepository_1.createLiteralRepository({ manager: manager, target: target, queryRunner: queryRunner }), { typeof: "TreeRepository", findTrees: function () {
