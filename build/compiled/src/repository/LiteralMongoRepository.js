 ...
 */
function createLiteralMongoRepository(_a) {
    var manager = _a.manager, target = _a.target, queryRunner = _a.queryRunner;
    return tslib_1.__assign({}, LiteralRepository_1.createLiteralRepository({ manager: manager, target: target, queryRunner: queryRunner }), { typeof: "MongoRepository", manager: manager, query: function (query, parameters) {
...
exports.createLiteralMongoRepository = createLiteralMongoRepository;
