...
var Connection = /** @class */ (function () {
    ...
    Object.defineProperty(Connection.prototype, "mongoManager", {
         ...
         */
        get: function () {
            if (this.manager.typeof !== "MongoEntityManager")
    ...
    Object.defineProperty(Connection.prototype, "sqljsManager", {
         ...
         */
        get: function () {
            if (this.manager.typeof !== "SqljsEntityManager")
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, _1.PromiseUtils.runInSequence(databases_1, function (database) { return queryRunner.clearDatabase(database); })];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
    ...
    Connection.prototype.buildMetadatas = function () {
        ...
        var optionSubscribers = this.options.subscribers instanceof Array ? this.options.subscribers :
            typeof this.options.subscribers === "object" ? Object.keys(this.options.subscribers).map(function (key) { return _this.options.subscribers[key]; }) :
                [];
        var subscribers = connectionMetadataBuilder.buildSubscribers(optionSubscribers);
        ObjectUtils_1.ObjectUtils.assign(this, { subscribers: subscribers });
        // build entity metadatas
        var optionEntities = this.options.entities instanceof Array ? this.options.entities :
            typeof this.options.entities === "object" ? Object.keys(this.options.entities).map(function (key) { return _this.options.entities[key]; }) :
                [];
        var entityMetadatas = connectionMetadataBuilder.buildEntityMetadatas(optionEntities);
        ObjectUtils_1.ObjectUtils.assign(this, { entityMetadatas: entityMetadatas });
        // create migration instances
        var optionMigrations = this.options.migrations instanceof Array ? this.options.migrations :
            typeof this.options.migrations === "object" ? Object.keys(this.options.migrations).map(function (key) { return _this.options.migrations[key]; }) :
                [];
        var migrations = connectionMetadataBuilder.buildMigrations(optionMigrations);
