...
var QueryBuilder = /** @class */ (function () {
    ...
    QueryBuilder.prototype.createFromAlias = function (entityTarget, aliasName) {
        ...
        if (this.connection.hasMetadata(entityTarget)) {
            ...
            var isSubQuery = entityTarget instanceof Function || (typeof entityTarget === "string" && entityTarget.substr(0, 1) === "(" && entityTarget.substr(-1) === ")");
            return this.expressionMap.createAlias({
                type: "from",
                name: aliasName,
    ...
    QueryBuilder.prototype.createWhereIdsExpression = function (ids) {
        ...
        if (metadata.primaryColumns.length > 1) {
            ...
            if (areAllNumbers) {
                return alias + this.escape(primaryColumn_2.databaseName) + " IN (" + normalizedValues.join(", ") + ")";
            }
            else {
