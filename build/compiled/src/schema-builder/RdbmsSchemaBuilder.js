            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.connection.driver instanceof SqliteDriver_1.SqliteDriver)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.queryRunner.query("PRAGMA foreign_keys = OFF")];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!!(this.connection.driver instanceof CockroachDriver_1.CockroachDriver)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.queryRunner.startTransaction()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        _a.trys.push([4, 16, 22, 24]);
                        tablePaths = this.entityToSyncMetadatas.map(function (metadata) { return metadata.tablePath; });
                        if (!(this.viewEntityToSyncMetadatas.length > 0)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.createTypeormMetadataTable()];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [4 /*yield*/, this.queryRunner.getTables(tablePaths)];
                    case 7:
                        _a.sent();
                    ...
                    case 9:
                        _a.sent();
                        if (!this.connection.queryResultCache) return [3 /*break*/, 11];
                        return [4 /*yield*/, this.connection.queryResultCache.synchronize(this.queryRunner)];
                    case 10:
                        _a.sent();
                        _a.label = 11;
                    case 11:
                        if (!!(this.connection.driver instanceof CockroachDriver_1.CockroachDriver)) return [3 /*break*/, 13];
                        return [4 /*yield*/, this.queryRunner.commitTransaction()];
                    case 12:
                        _a.sent();
                        _a.label = 13;
                    case 13:
                        if (!(this.connection.driver instanceof SqliteDriver_1.SqliteDriver)) return [3 /*break*/, 15];
                        return [4 /*yield*/, this.queryRunner.query("PRAGMA foreign_keys = ON")];
                    case 14:
                        _a.sent();
                        _a.label = 15;
                    ...
                    case 17:
                        ...
                        if (!!(this.connection.driver instanceof CockroachDriver_1.CockroachDriver)) return [3 /*break*/, 19];
                    ...
                    case 22: return [4 /*yield*/, this.queryRunner.release()];
                    case 23:
                        _a.sent();
                        return [7 /*endfinally*/];
