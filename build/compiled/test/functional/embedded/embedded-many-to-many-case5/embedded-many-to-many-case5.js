...
describe("embedded > embedded-many-to-many-case5", function () {
    var connections;
    ...
    describe("owner side", function () {
        it("should insert, load, update and remove entities with embeddeds when embedded entity having ManyToMany relation with multiple primary keys (multiple keys in both sides)", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
