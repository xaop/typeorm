...
var Category = /** @class */ (function () {
    ...
    tslib_1.__decorate([
        ManyToMany_1.ManyToMany(function (type) { return Post_1.Post; }, function (post) { return post.categoriesNamedAll; }),
        tslib_1.__metadata("design:type", Promise)
    ], Category.prototype, "postsNamedAll", void 0);
    tslib_1.__decorate([
        OneToMany_1.OneToMany(function (type) { return Post_1.Post; }, function (post) { return post.categoryNamedAll; }),
        tslib_1.__metadata("design:type", Promise)
    ], Category.prototype, "onePostsNamedAll", void 0);
    tslib_1.__decorate([
        OneToOne_1.OneToOne(function (type) { return Post_1.Post; }, function (post) { return post.oneCategoryNamedAll; }),
        tslib_1.__metadata("design:type", Promise)
    ], Category.prototype, "onePostNamedAll", void 0);
    Category = tslib_1.__decorate([
        Entity_1.Entity("s_category_named_all", {
            orderBy: {
                id: "ASC",
            }
        })
