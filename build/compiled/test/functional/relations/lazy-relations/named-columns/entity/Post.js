...
var Post = /** @class */ (function () {
    ...
    tslib_1.__decorate([
        ManyToMany_1.ManyToMany(function (type) { return Category_1.Category; }, function (category) { return category.postsNamedColumn; }),
        JoinTable_1.JoinTable(),
        tslib_1.__metadata("design:type", Promise)
    ], Post.prototype, "categoriesNamedColumn", void 0);
    tslib_1.__decorate([
        ManyToOne_1.ManyToOne(function (type) { return Category_1.Category; }, function (category) { return category.onePostsNamedColumn; }),
        JoinColumn_1.JoinColumn({
    ...
    tslib_1.__decorate([
        OneToOne_1.OneToOne(function (type) { return Category_1.Category; }, function (category) { return category.onePostNamedColumn; }),
        JoinColumn_1.JoinColumn({
