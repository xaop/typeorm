...
describe("repository > decrement method", function () {
    describe("basic", function () {
        ...
        it("should decrement value", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, connection
                                .manager
                                .decrement(Post_1.Post, { id: 2 }, "counter", 3)];
                    case 3:
                        // decrement counter of post 2
                        _a.sent();
        ...
        it("should accept string as input and decrement value", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var post1, post2, loadedPost1, loadedPost2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, connection
                                .manager
                                .decrement(Post_1.Post, { id: 2 }, "counter", "33")];
                    case 3:
                        // decrement counter of post 2
                        _a.sent();
                        return [4 /*yield*/, connection.manager.findOne(Post_1.Post, 1)];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, connection
                                .manager
                                .decrement(PostBigInt_1.PostBigInt, { id: 2 }, "counter", "9000000000000000000")];
                    case 3:
                        // decrement counter of post 2
                        _a.sent();
