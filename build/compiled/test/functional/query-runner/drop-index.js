...
describe("query runner > drop index", function () {
    var connections;
    ...
    it("should correctly drop index and revert drop", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, queryRunner.dropIndex(table, table.indices[0])];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, queryRunner.getTable("student")];
                case 3:
