        ...
        connections.filter(function (connection, index) { return index === 0; }).map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        /*const post4 = */ _a.sent();
                        connection.manager.observeManyAndCount(Post_1.Post, { where: { id: src_1.LessThan(4), active: true } }).subscribe(function (_a) {
...
//# sourceMappingURL=observers-many-and-count-update.js.map