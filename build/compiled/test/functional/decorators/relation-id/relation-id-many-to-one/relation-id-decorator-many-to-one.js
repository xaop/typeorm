...
describe("decorators > relation-id-decorator > many-to-one", function () {
    var connections;
    ...
    it("should load ids when RelationId decorator used", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
