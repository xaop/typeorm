...
describe("uuid-cockroach", function () {
    var connections;
    ...
    it("should make correct schema with CockroachDB uuid type", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    chai_1.expect(table).not.to.be.undefined;
                    chai_1.expect(table.columns.find(function (tableColumn) { return tableColumn.name === "id" && tableColumn.type === "uuid" && tableColumn.isGenerated; })).to.be.not.empty;
                    return [2 /*return*/];
            }
        });
    }); })); });
    ...
    it("should persist uuid correctly when it is generated non primary column", function () { return Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, postRepository.findOne(post2.id)];
                case 7:
                    loadedPost2 = _a.sent();
