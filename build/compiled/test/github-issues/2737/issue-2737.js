...
describe("github issues > #2737 sync schema on columns without precision, width or default value set to null", function () {
    var connections;
    it("MySQL, MariaDb, Oracle", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _this = this;
                    ...
                    return [4 /*yield*/, Promise.all(connections.map(function (connection) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        syncQueries = _a.sent();
                                        chai_1.expect(syncQueries.downQueries).to.be.empty;
                                        chai_1.expect(syncQueries.upQueries).to.be.empty;
                                        return [2 /*return*/];
                                }
                            });
                        }); }))];
