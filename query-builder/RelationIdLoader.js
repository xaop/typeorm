                        ...
                        return [2 /*return*/, entities.map(function (entity) {
                                ...
                                var entityRelationIds = relationIds.filter(function (relationId) {
                                    return inverseColumns.every(function (column) {
                                        ...
                                        var columnName = DriverUtils_1.DriverUtils.buildColumnAlias(_this.connection.driver, column.entityMetadata.name + "_" + column.propertyAliasName);
                                ...
                                relatedEntities.forEach(function (relatedEntity) {
                                    entityRelationIds.forEach(function (relationId) {
                                        var relatedEntityMatched = columns.every(function (column) {
                                            ...
                                            var columnName = DriverUtils_1.DriverUtils.buildColumnAlias(_this.connection.driver, column.entityMetadata.name + "_" + relation.propertyPath.replace(".", "_") + "_" + column.propertyPath.replace(".", "_"));
