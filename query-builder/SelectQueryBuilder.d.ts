...
declare type QueryFindOptions<E> = Pick<FindOptions<E>, "select"> & // TODO: Think of better name
Pick<FindOptions<E>, "where"> & Pick<FindOptions<E>, "order"> & Pick<FindOptions<E>, "relations"> & Pick<FindOptions<E>, "skip"> & Pick<FindOptions<E>, "take"> & Pick<FindExtraOptions, "loadRelationIds"> & Pick<FindExtraOptions, "pagination">;
/**
