                            ...
                            case 1:
                                ...
                                condition = rawEntities.map(function (rawEntity, index) {
                                    return joinColumns_1.map(function (joinColumn) {
                                        ...
                                        var parameterName = DriverUtils_1.DriverUtils.buildColumnAlias(_this.connection.driver, joinColumn.databaseName + index);
                            ...
                            case 3:
                                ...
                                joinColumnConditions = mappedColumns.map(function (mappedColumn, index) {
                                    return Object.keys(mappedColumn).map(function (key) {
                                        ...
                                        var parameterName = DriverUtils_1.DriverUtils.buildColumnAlias(_this.connection.driver, key + index);
