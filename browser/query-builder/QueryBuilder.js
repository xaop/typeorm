...
var QueryBuilder = /** @class */ (function () {
                ...
                columnsExpression +=
                    " INTO " +
                        columns
                            ...
                            var parameterName = DriverUtils.buildColumnAlias(_this.connection.driver, "output", column.databaseName);
    ...
    QueryBuilder.prototype.createWhereIdsExpression = function (ids) {
        ...
        if (!metadata.hasMultiplePrimaryKeys &&
            ...
            if (!primaryColumn_1.transformer) {
                return this.computeWhereParameter((_a = {},
                    _a[primaryColumn_1.propertyName] = In(normalized.map(function (id) {
        ...
        if (metadata.primaryColumns.length > 1) {
            ...
            if (areAllNumbers) {
                paramAndValues = DriverUtils.buildParamAndValuesForInClause(this.connection.driver, "" + (alias + this.escape(primaryColumn_2.databaseName)), normalizedValues);
                return paramAndValues.param + " IN (" + paramAndValues.values.join(", ") + ")";
            }
            else {
                paramAndValues = DriverUtils.buildParamAndValuesForInClause(this.connection.driver, "" + (alias + this.escape(primaryColumn_2.databaseName)), normalized.map(function (val) {
