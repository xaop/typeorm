...
import { FindOptions, FindOptionsOrder, FindOptionsRelation, FindOptionsSelect, FindOptionsWhere, FindExtraOptions } from "../find-options/FindOptions";
import { RelationMetadata } from "../metadata/RelationMetadata";
import { Connection } from "..";
declare type QueryFindOptions<E> = // TODO: Think of better name
Pick<FindOptions<E>, "select"> & Pick<FindOptions<E>, "where"> & Pick<FindOptions<E>, "order"> & Pick<FindOptions<E>, "relations"> & Pick<FindOptions<E>, "skip"> & Pick<FindOptions<E>, "take"> & Pick<FindExtraOptions, "loadRelationIds"> & Pick<FindExtraOptions, "pagination">;
/**
...
export declare class SelectQueryBuilder<Entity> extends QueryBuilder<Entity> implements WhereExpression {
    ...
    protected applyFindOptionsOrmOptions(findOptions: FindOptions<Entity>): void;
