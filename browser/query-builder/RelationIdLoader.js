...
var RelationIdLoader = /** @class */ (function () {
    ...
    RelationIdLoader.prototype.load = function (relation, entityOrEntities, relatedEntityOrRelatedEntities) {
        ...
        var relatedEntities = Array.isArray(relatedEntityOrRelatedEntities) ? relatedEntityOrRelatedEntities : (relatedEntityOrRelatedEntities ? [relatedEntityOrRelatedEntities] : undefined);
                        ...
                        return [2 /*return*/, entities.map(function (entity) {
                                ...
                                var entityRelationIds = relationIds.filter(function (relationId) {
                                    return inverseColumns.every(function (column) {
                                        ...
                                        var columnName = DriverUtils.buildColumnAlias(_this.connection.driver, column.entityMetadata.name + "_" + column.propertyAliasName);
                                ...
                                relatedEntities.forEach(function (relatedEntity) {
                                    entityRelationIds.forEach(function (relationId) {
                                        var relatedEntityMatched = columns.every(function (column) {
                                            ...
                                            var columnName = DriverUtils.buildColumnAlias(_this.connection.driver, column.entityMetadata.name + "_" + relation.propertyPath.replace(".", "_") + "_" + column.propertyPath.replace(".", "_"));
    ...
    RelationIdLoader.prototype.loadForManyToMany = function (relation, entities, relatedEntities) {
        ...
        // }
        // execute query
        var condition = [condition1, condition2].filter(function (v) { return v.length > 0; }).join(" AND ");
        return qb
