        ...
        return allColumns.map(function (column) {
            ...
            return {
                ...
                aliasName: selection && selection.aliasName
                    ? selection.aliasName
                    : DriverUtils.buildColumnAlias(_this.connection.driver, aliasName, column.databaseName),
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        querySelects = metadata_1.primaryColumns.map(function (primaryColumn) {
                            ...
                            var columnAlias = _this.escape(DriverUtils.buildColumnAlias(_this.connection.driver, mainAliasName_1, primaryColumn.databaseName, { extraNeededLength: 4 }));
                            ...
                            return distinctAlias + "." + columnAlias + " as \"ids_" + DriverUtils.buildColumnAlias(_this.connection.driver, mainAliasName_1, primaryColumn.databaseName, { extraNeededLength: 4 }) + "\"";
                        });
                        clonnedQb = cloneQb1
                            // .setFindOptions({
                    ...
                    case 1:
                        ...
                        if (metadata_1.hasMultiplePrimaryKeys) {
                            ...
                            ids = rawResults.map(function (result) {
                                return result["ids_" +
                                    DriverUtils.buildColumnAlias(_this.connection.driver, mainAliasName_1, metadata_1.primaryColumns[0].databaseName, { extraNeededLength: 4 })];
                            });
                            areAllNumbers = ids.every(function (id) { return typeof id === "number"; });
                            paramAndValues = DriverUtils.buildParamAndValuesForInClause(this.connection.driver, mainAliasName_1 + "." + metadata_1.primaryColumns[0].propertyPath, ids);
                            if (areAllNumbers) {
                                    ...
                                    case 0:
                                        ...
                                        queryBuilder = this.createQueryBuilder()
                                            ...
                                            select: this.findOptions.select &&
                                                ...
                                                ? OrmUtils.deepValue(this.findOptions.select, relation.propertyPath)
                                                : undefined,
                                            ...
                                            relations: this.findOptions.relations &&
                                                ...
                                                ? OrmUtils.deepValue(this.findOptions.relations, relation.propertyPath)
                                                : undefined
                                        });
        ...
        var selectString = Object.keys(orderBys)
            ...
            if (orderCriteria.indexOf(".") !== -1) {
                ...
                return (_this.escape(parentAlias) +
                    "." +
                    _this.escape(DriverUtils.buildColumnAlias(_this.connection.driver, aliasName, column.databaseName)));
            }
            else {
        ...
        Object.keys(orderBys).forEach(function (orderCriteria) {
            if (orderCriteria.indexOf(".") !== -1) {
                ...
                orderByObject[_this.escape(parentAlias) +
                    "." +
                    _this.escape(DriverUtils.buildColumnAlias(_this.connection.driver, aliasName, column.databaseName))] = orderBys[orderCriteria];
            }
            else {
                if (_this.expressionMap.selects.find(function (select) {
                    return select.selection === orderCriteria ||
    ...
    SelectQueryBuilder.prototype.buildOrder = function (order, metadata, alias, embedPrefix) {
        var _loop_1 = function (key) {
            ...
            if (column) {
                ...
                // const joinAlias = alias + "_" + relation.propertyName;
                var joinAlias_1 = DriverUtils.buildColumnAlias(this_1.connection.driver, alias, relation.propertyName);
            ...
            var _loop_2 = function (key) {
                ...
                if (column) {
                    ...
                    var parameterValue = column.transformer
                        ? ApplyValueTransformers.transformTo(column.transformer, where[key])
                        : where[key];
                    if (parameterValue === null) {
                        ...
                        if (parameterValue.useParameter) {
                            ...
                            var extraNeededLength = ("" + realParameterValues.length)
                                .length;
                            var parameterName_1 = DriverUtils.buildColumnAlias(this_2.connection.driver, alias, propertyPath.split(".").join("_") +
                                "_" +
                        ...
                        // Hack Julien (Fix the parameter too long issue we have on oracle (limit is 30)
                        // const parameterName = alias + "_" + propertyPath.split(".").join("_") + "_" + parameterIndex;
                        var parameterName2 = DriverUtils.buildColumnAlias(this_2.connection.driver, alias, propertyPath.split(".").join("_") +
                            "_" +
                            parameterIndex);
                    ...
                    if (where[key] instanceof FindOperator) {
                        ...
                        // Hack Julien (Fix the parameter too long issue we have on oracle (limit is 30)
                        // const joinAlias = alias + "_" + relation.propertyName;
                        var joinAlias_2 = DriverUtils.buildColumnAlias(this_2.connection.driver, alias, relation.propertyName);
