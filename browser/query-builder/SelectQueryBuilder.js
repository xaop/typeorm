                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (metadata_1.hasMultiplePrimaryKeys) {
                            ...
                            ids = rawResults.map(function (result) { return result["ids_" + DriverUtils.buildColumnAlias(_this.connection.driver, mainAliasName_1, metadata_1.primaryColumns[0].databaseName, { extraNeededLength: 4 })]; });
                ...
                if (column) {
                    ...
                    if (parameterValue === null) {
                        ...
                        if (parameterValue.useParameter) {
                            ...
                            var parameterName_1 = DriverUtils.buildColumnAlias(this_2.connection.driver, alias, propertyPath.split(".").join("_") + "_" + parameterIndex, { extraNeededLength: extraNeededLength });
                        ...
                        // Hack Julien (Fix the parameter too long issue we have on oracle (limit is 30)
                        // const parameterName = alias + "_" + propertyPath.split(".").join("_") + "_" + parameterIndex;
                        var parameterName2 = DriverUtils.buildColumnAlias(this_2.connection.driver, alias, propertyPath.split(".").join("_") + "_" + parameterIndex);
