                    ...
                    return tslib_1.__generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                paramAndValues = DriverUtils.buildParamAndValuesForInClause(this.connection.driver, inverseSideTableAlias + "." + inverseSidePropertyName, referenceColumnValues);
                            ...
                            case 2:
                                ...
                                paramAndValues = DriverUtils.buildParamAndValuesForInClause(this.connection.driver, junctionAlias + "." + firstJunctionColumn.propertyName, referenceColumnValues.map(function (vals) {
